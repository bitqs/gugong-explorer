...
- 无构建步骤、无 npm 依赖用于运行时；PixiJS 仅通过 CDN ESM 引入：`https://cdn.jsdelivr.net/npm/pixi.js@8/dist/pixi.min.mjs`
...
```js
import { Application, Assets, Container, Sprite, Graphics } from 'https://cdn.jsdelivr.net/npm/pixi.js@8/dist/pixi.min.mjs';
